Shader "Hidden/dynlightmap/VacuumShaders/Subsurface Scattering/Cutout/Reflective/Bumped Specular" 
{
	Properties 
	{
		[V_MaterialTag]
	...
	SubShader 
	{
		...
		CGPROGRAM
		#pragma surface surf TransBlinnPhong alphatest:_Cutoff noambient
		#pragma target 3.0
