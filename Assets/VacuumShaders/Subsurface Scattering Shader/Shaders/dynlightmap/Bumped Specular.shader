Shader "Hidden/dynlightmap/VacuumShaders/Subsurface Scattering/Bumped Specular" 
{
	Properties 
	{
		[V_MaterialTag]
	...
	SubShader 
	{
		Tags { "Queue"="Geometry" "RenderType"="Opaque" "SSSType"="Legacy/PixelLit"}
		LOD 400

		CGPROGRAM
		#pragma surface surf TransBlinnPhong noambient
		#pragma target 3.0
