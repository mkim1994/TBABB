Shader "Hidden/dynlightmap/VacuumShaders/Subsurface Scattering/Cutout/Reflective/Bumped Diffuse" 
{
	Properties 
	{
		[V_MaterialTag]
	...
	SubShader 
	{
		...
		CGPROGRAM
		#pragma surface surf TransPhong alphatest:_Cutoff noambient
		#pragma target 3.0
