Shader "Hidden/dynlightmap/VacuumShaders/Subsurface Scattering/Transparent/Reflective/Bumped Specular" 
{
	Properties 
	{
		[V_MaterialTag]
	...
	SubShader 
	{
		...
		CGPROGRAM
		#pragma surface surf TransBlinnPhong noambient alpha:fade
		#pragma target 3.0
