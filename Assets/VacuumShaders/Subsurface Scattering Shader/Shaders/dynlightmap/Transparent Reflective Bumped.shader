Shader "Hidden/dynlightmap/VacuumShaders/Subsurface Scattering/Transparent/Reflective/Bumped Diffuse" 
{
	Properties 
	{
		[V_MaterialTag]
	...
	SubShader 
	{
		...
		CGPROGRAM
		#pragma surface surf TransPhong noambient alpha:fade
		#pragma target 3.0
