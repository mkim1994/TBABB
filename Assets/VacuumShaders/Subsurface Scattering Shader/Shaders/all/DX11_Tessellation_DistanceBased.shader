Shader "Hidden/all/VacuumShaders/Subsurface Scattering/Tessellation (DX11)/Distance Based"
{
	Properties 
	{
		[V_MaterialTag]
	 ...
	 SubShader 
	 {
            ...
            CGPROGRAM
            #pragma surface surf TransBlinnPhong addshadow vertex:disp tessellate:tessCalc nolightmap 
            #pragma target 5.0
