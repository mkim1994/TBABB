Shader "Hidden/ambient/VacuumShaders/Subsurface Scattering/Tessellation (DX11)/Length Based"
{
	Properties 
	{
		[V_MaterialTag]
	 ...
	 SubShader  
	 {
            ...
            CGPROGRAM
            #pragma surface surf TransBlinnPhong addshadow vertex:disp tessellate:tessCalc nolightmap nodynlightmap
            #pragma target 5.0
