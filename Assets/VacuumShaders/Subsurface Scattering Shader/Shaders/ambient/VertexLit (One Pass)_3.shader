Shader "Hidden/ambient/VacuumShaders/Subsurface Scattering/VertexLit (Mobile)/LightCount  3" 
{
	Properties 
	{
		[V_MaterialTag]
	...
	SubShader 
	{
		Tags { "RenderType"="Opaque" "SSSType"="Legacy/OnePass_3"}
		LOD 200
		...
		Pass  
		{
			...
			#pragma shader_feature V_SSS_POW_ONE V_SSS_POW_TWO V_SSS_POW_FOUR V_SSS_POW_EIGHT V_SSS_POW_SIXTEEN
