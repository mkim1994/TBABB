Shader "Hidden/ambient/VacuumShaders/Subsurface Scattering/Cutout/Reflective/Bumped Diffuse" 
{
	Properties 
	{
		[V_MaterialTag]
	...
	SubShader 
	{
		...
		CGPROGRAM
		#pragma surface surf TransPhong alphatest:_Cutoff nodynlightmap
		#pragma target 3.0
