Shader "Hidden/ambient/VacuumShaders/Subsurface Scattering/Cutout/Reflective/Bumped Specular" 
{
	Properties 
	{
		[V_MaterialTag]
		...
		_MainTex ("Base (RGB) RefGlossTrans (A)", 2D) = "white" {}
	...
	SubShader 
	{
		...
		CGPROGRAM
		#pragma surface surf TransBlinnPhong alphatest:_Cutoff nodynlightmap
		#pragma target 3.0
